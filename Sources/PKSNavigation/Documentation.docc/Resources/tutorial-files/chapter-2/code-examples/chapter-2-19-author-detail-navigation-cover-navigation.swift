...
struct AuthorDetail: View {
    ...
    var body: some View {
            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading) {
                    ...
                    ArticleRow(article: Array.mockData[0])
                        ...
                        .onTapGesture {
                            authorNavigationManager.navigate(
                                to: HomeTabNavigationablePages.detail(
                                    article: Array.mockData[0],
                                    recommendations: .shuffledMockData
                                ),
                                presentation: .cover
                            )
                        }
        ...
        // Register Sheet and Cover stack - Always use the current flow navigation manager. Don't use the parent!
        .modalNavigationStackManager(navigationManager: authorNavigationManager)
    }
}
