    ...
    private var header: some View {
        VStack(alignment: .leading) {
            ...
            Text("by \(article.author) • \(article.date)")
                ...
                .underline()
                .onTapGesture {
                    navigationManager.navigate(to: HomeTabNavigationablePages.authorDetail, presentation: .sheet)
                }
        }
        .padding()
                ...
                HStack(spacing: 0) {
                    ...
                    ForEach(recommendations, id: \.id) { recommendation in
                        RecommendationCard(recommendation)
                            ...
                            .onTapGesture {
                                navigationManager.navigate(to: HomeTabNavigationablePages.detail(article: recommendation, recommendations: .shuffledMockData))
                            }
                    }
                }
            }
